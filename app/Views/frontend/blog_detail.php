...
<section class="blog_banner">
    <img src="<?php echo $detail->image?base_url($detail->image):base_url($config_logo); ?>" loading="eager" alt="blog-banner" class="inner_bg" />
    <div class="container">
        <div class="row">
        ...
        <div class="row g-0 align-items-center for-bor">
            <div class="col-lg-8 text-center m-auto">
                <div class="text-wrap">
                    <div class="wrap">
                        <div class="title-wrap mb-4">
                            <h2 class="title" data-cue="slideInUp" >Related Blogs</h2>
                        </div>
                    </div>
                </div>
            </div>
