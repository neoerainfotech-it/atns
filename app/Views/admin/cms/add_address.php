    ...
    <div class="container-fluid">
      ...
      <?php endif ?>
            ...
            <div class="card-body">
              ...
              <div class="col-sm-10">
                  <?php if (!empty($image)): ?>
                    <img src="<?php echo base_url($image) ?>" width="100" height="100" alt="user image">
                  <?php endif ?>
                  ...
                  <div class="row mb-3 ">
                        ...
                        <div class="row mb-3 ">
                        <label for="input-name" class="col-sm-2 col-form-label">Phone </label>
                        <div class="col-sm-10">                           
                            <input type="text" name="phone"   class="form-control" value="<?php echo set_value('phone',$phone); ?>" />
