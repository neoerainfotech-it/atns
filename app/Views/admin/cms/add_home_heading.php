                        ...
                        <div id="tab-seo" class="tab-pane">
                            <fieldset>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="meta_keyword" class="form-control" rows="3" placeholder="microsoft solutions partner, azure cloud development automation optimization" class="form-control"><?php echo set_value('meta_keyword', $meta_keyword ?? ''); ?></textarea>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                        ...
                        <div id="tab-feature" class="tab-pane">
                            <div class="table-responsive">
                                <table id="images" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <td class="text-start required">Value / Number</td>
                                            <td class="text-start">Description Summary Text</td>
                                            <td class="text-start">Symbol (e.g., +)</td>
                                            <td class="text-start required">Sort Order Mapping</td>
                                            <td>Action</td>
                                        </tr>
                                    </thead>
                                    <tbody>
