    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
                ...
                <a href="<?php echo base_url('admin/global_presence'); ?>" data-bs-toggle="tooltip" title="Back" class="btn btn-light">
            ...
            <div class="card-body">
                 ...
                 <form action="<?php echo $form_action; ?>" method="post" enctype="multipart/form-data" id="form-user-group" class="form-horizontal">
                   ...
                   <div class="row mb-3 required">
                        <label for="input-name" class="col-sm-2 col-form-label">Country Name</label>
                        <div class="col-sm-10">                           
                    ...
                    <div class="row mb-3 required">
                        <label for="input-name" class="col-sm-2 col-form-label">State Name (use ',' for new state) </label>
                        <div class="col-sm-10">                           
                            <textarea name="state" rows="5"  class="form-control"><?php echo set_value('state',$state); ?></textarea>
