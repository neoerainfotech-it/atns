...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item"><a href="#tab-feature" data-bs-toggle="tab" class="nav-link">Why</a></li>
      ...
      <fieldset>
        <label>Overview</label>
          ...
          <div class="row mb-3 ">
            ...
            <div class="row mb-3 ">
            <label for="input-username" class="col-sm-2 col-form-label"> Description </label>
              <div class="col-sm-10">
                   <textarea name="fullDescription" class="form-control" rows="5"><?php echo set_value('fullDescription',$fullDescription); ?></textarea>

              </div>
          </div>

        
        <label>Why It Works For You </label>
        <div class="row mb-3 ">
              <label for="input-username" class="col-sm-2 col-form-label">Heading</label>
              <div class="col-sm-10">
                 
                  <input type="text" name="featureHeading" value="<?php echo set_value('featureHeading',$featureHeading); ?>" placeholder=""  class="form-control" />
              </div>
          </div>
        ...
        <legend>Images</legend>
         ...
         <legend>Industries</legend>
          ...
          <!--</div>-->
           ...
           <div class="row mb-3">
              <label for="input-email" class="col-sm-2 col-form-label">Feature (show on home)</label>
              <div class="col-sm-10">       
...
<script type="text/javascript">
  var image_row = 0;
    ...
    html += '  <td class="text-left" style="width: 30%;"><textarea name="featureDescription[]"  placeholder="Description" class="form-control" id="editor'+image_row+'"></textarea></td>';
