    ...
    <div class="container-fluid">
      ...
      <?php endif ?>
           ...
           <div class="table-responsive">
            <table class="table table-bordered table-hover">
                <thead>
                  ...
                  <td class="text-left">Header Sort Order</td>
                   <td class="text-left">Footer Sort Order</td>
         ...
         <td class="text-right"><?php echo $value->sort_order; ?></td>
           <td class="text-right"><?php echo $value->sort_order_footer; ?></td>
         <td class="text-right">
           ...
           <i class="fa fa-pencil"></i>
            ...
            <tr>
             ...
             <td class="text-right"><?php echo $l1->sort_order; ?></td>
                <td class="text-right"><?php echo $l1->sort_order_footer; ?></td>
             <td class="text-right">
            ...
            <tr>
             ...
             <td class="text-right"><?php echo $l2->sort_order; ?></td>
                    <td class="text-right"><?php echo $l2->sort_order_footer; ?></td>
             <td class="text-right">
            ...
            <tr>
             ...
             <td class="text-right"><?php echo $l3->sort_order; ?></td>
                                 <td class="text-right"><?php echo $l3->sort_order_footer; ?></td>
             <td class="text-right">
