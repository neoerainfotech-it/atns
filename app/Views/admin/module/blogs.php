          ...
          <div class="card-body">
           ...
           <div class="mb-3">
            ...
            <div class="text-end">
              ...
              <a href="<?php echo base_url('admin/blogs'); ?>" class="btn btn-light"><i class="fa-solid fa-filter"></i> Reset</a>
            </div>
            </form>
          </div>
        </div>
                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                   ...
                                   <td class="text-start">Author Name</td> <td class="text-start">Short Description</td>
                          ...
                          <?php if(!empty($detail)){
                           foreach ($detail as $key => $value){ ?>
                            ...
                            <?php } ?>
                               ...
                               <td class="text-start fw-bold text-secondary"><?php echo !empty($value->author_name) ? esc($value->author_name) : '<span class="text-muted small">Not Set</span>'; ?></td> <td class="text-start"><?php echo $value->shortDescription; ?></td>
